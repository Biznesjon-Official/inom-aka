...
import { Search, CreditCard, Plus, List, LayoutGrid, Trash2, Settings2, ExternalLink, Printer } from 'lucide-react'
...
interface Debt {
  ...
  entries?: { amount: number; date: string; note?: string; sale?: { items: SaleItem[] } | null }[]
}
                  ...
                  <div className="mt-3 border-t pt-2 space-y-2">
                    {d.entries && d.entries.length > 0 && (
                      <div>
                        <div className="text-xs font-medium text-slate-500 mb-1">Qarz tarixi:</div>
                        {d.entries.map((e, i) => (
                          <div key={i} className="flex justify-between text-xs bg-orange-50 rounded px-2 py-1 mb-0.5">
