...
// Cron: every day at 20:00 Tashkent time
cron.schedule('0 20 * * *', runAllReports, { timezone: 'Asia/Tashkent' })

console.log('Bot started. Cron scheduled for 20:00 Asia/Tashkent.')
